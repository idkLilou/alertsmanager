...
### Added
- Sélection multiple des cibles pour une même alerte (utilisateurs, groupes et profils).

### Fixed
- Déduplication des destinataires pour qu’un même utilisateur ne reçoive qu’un seul mail même s’il est ciblé plusieurs fois.
